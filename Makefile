...
USER_APPS := hello paint plasma crash hog spin notes menu twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter heir nested
...
WIN_APPS := winclock winpad winfiles
...
USER64_APPS := hello plasma paint notes menu crash twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter heir nested
...
WIN64_APPS := winclock winpad winfiles
