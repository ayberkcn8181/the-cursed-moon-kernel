...
USER_APPS := hello paint plasma crash hog spin notes menu twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter
...
USER64_APPS := hello plasma paint notes menu crash twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter
