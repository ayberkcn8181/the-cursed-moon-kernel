...
USER_APPS := hello paint plasma crash hog spin notes menu twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter heir nested bequest probe quoted mapped threads sync blocking intr death stdin bigfile heap swapx jobs
...
WIN_APPS := winclock winpad winfiles winenv winprobe winseh winargv winmods winmap winthread winsync winpipe windeath
...
USER64_APPS := hello plasma paint notes menu crash twins relay echo2 sigdemo race reaper redirect mux masked arena seeker browse waiter heir nested bequest probe quoted mapped threads sync blocking intr death stdin bigfile heap swapx jobs
...
WIN64_APPS := winclock winpad winfiles winenv winprobe winseh winargv winmods winmap winthread winsync winpipe windeath
